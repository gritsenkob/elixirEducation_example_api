defmodule API.Helpers.CurrencyHelper do
  ...
  @spec get_currency_rate_data_by_symbol(any()) ::
          {:error, <<_::112>>} | {:ok, DAL.Schemas.CurrencyRate.t()}
  ...
  @spec get_currency_data_by_symbol(any()) ::
          {:error, <<_::112>>} | {:ok, DAL.Schemas.Currency.t()}
  ...
  @spec get_clean_currency_data_map(any()) :: {:error, <<_::112>>} | {:ok, map()}
  ...
  @spec get_clean_currency_rate_data_map(any()) :: {:error, <<_::112>>} | {:ok, map()}
